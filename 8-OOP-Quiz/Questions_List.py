...
question_list = [
    ...
    Q("Doktorunuz size 3 hap verir ve bunları yarımşar saat arayla almanızı tavsiye ederse, ilaçların tamamını bitirmeniz ne kadar sürer?", ["1 Saat", "1,5 Saat", "3 Saat"], "3")
    ]
